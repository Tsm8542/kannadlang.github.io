...
function z(){
    ...
    if(genre=="balbharti")genre="Balbharti Kannad";
    else if(genre=="kumarbharti")genre="Kumarbharti Kannad";
    else if(genre=="sugambharti")genre="Sugambharti Kannad";
    else if(genre=="yuvakbharti")genre="Yuvakbharti Kannad";
    let m="";
